...
class SetupLockPasswordActivity:BaseActivity<ActivityLockBinding>(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPrefs = this@SetupLockPasswordActivity.getSharedPreferences(DataManger.PATTERN_SHARING, Context.MODE_PRIVATE)
        ...
        binding.patternLock.setOnPatternListener(object : PatternLockView.OnPatternListener{
            override fun onComplete(ids: ArrayList<Int>): Boolean {
                ...
                if (argument==1){
                    ...
                    val intent = Intent(this@SetupLockPasswordActivity, SetupLockPasswordActivity::class.java)
                    ...
                    if (str==argument2){
                        ...
                        finish()
                        val intent = Intent(this@SetupLockPasswordActivity, MainActivity::class.java)
                        startActivity(intent)
                    }
                }
    ...
    var dispatcher = onBackPressedDispatcher.addCallback(onBackPressedCallback = object :
